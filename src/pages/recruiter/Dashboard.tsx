    ...
    <div className="min-h-screen bg-cyber-dark text-zinc-100 font-sans antialiased selection:bg-accent-pink selection:text-white">
      ...
      <nav className="sticky top-0 z-50 bg-cyber-dark/80 backdrop-blur-xl border-b border-zinc-800/60 px-6 lg:px-16 py-5 flex justify-between items-center">
        ...
        <div className="flex items-center gap-8">
          <button className="text-xs font-mono tracking-widest text-zinc-400 hover:text-accent-pink transition-colors">
            // POST_JOB
          </button>
          <button className="text-xs font-mono tracking-widest text-zinc-400 hover:text-accent-cyan transition-colors">
            // SETTINGS
          </button>
        </div>
      </nav>

      <main className="max-w-7xl mx-auto px-6 lg:px-16 py-12 pb-20">
        {/* Welcome Section */}
